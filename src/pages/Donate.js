...
export default function Donate() {
  ...
  const handleAmountPreset = (amount) => {
    ...
    setFormData((previous) => ({ ...previous, amount: String(amount) }));
  };
  ...
  const handleCampaignDonateClick = (campaignId) => {
    setFormData((previous) => ({ ...previous, campaignId }));
    setThankYouMessage("");
    focusForm();
  };
    ...
    try {
      ...
      setCampaigns((previous) =>
        previous.map((campaign) => {
          if (campaign.id !== paymentDraft.campaignId) {
            return campaign;
          }
  ...
  return (
    <div className="donate-page">
      <section className="donate-hero">
        <div className="donate-shell donate-hero-content">
          <p className="donate-eyebrow">AlokBortika Community Fund</p>
          <h1>Support Your Community</h1>
          <p className="donate-hero-subtitle">
            Every donation helps residents, volunteers, and organizations solve local
            problems faster, from road damage to public safety concerns.
          </p>
      ...
      <form className="donate-shell donate-form-shell" onSubmit={handleOpenPayment} noValidate>
        <section className="donate-section donate-form-section" ref={formSectionRef}>
          ...
          <div className="donate-form-grid">
            <label htmlFor="donorName">
              ...
              />
              {errors.donorName ? <span className="donate-input-error">{errors.donorName}</span> : null}
            </label>
            ...
            <label htmlFor="email">
              ...
              <input
                ...
                onChange={handleInputChange}
              />
              {errors.email ? <span className="donate-input-error">{errors.email}</span> : null}
            </label>
            ...
            <label htmlFor="message" className="donate-full-width">
              Optional Message
              <textarea
                id="message"
                name="message"
                rows="4"
                placeholder="Leave a note for the campaign team (optional)."
          ...
          <div className="donate-amount-block">
            ...
            <label htmlFor="amount" className="donate-amount-input">
              ...
              <input
                ...
                onChange={handleInputChange}
              />
              {errors.amount ? <span className="donate-input-error">{errors.amount}</span> : null}
            </label>
        ...
        <section className="donate-section donate-payment-section">
          <div className="donate-section-head">
            ...
            <p>
              This is a simulated payment flow for now. It is structured so you can
              connect a real payment gateway API later.
            </p>
          </div>
          ...
          {errors.paymentMethod ? (
            <span className="donate-input-error donate-top-gap">{errors.paymentMethod}</span>
          ) : null}

          <div className="donate-payment-summary">
            <h3>Payment Summary</h3>
            <p>
              <strong>Campaign:</strong> {selectedCampaign ? selectedCampaign.title : "Not selected"}
            </p>
            <p>
          ...
          <button type="submit" className="donate-btn donate-btn-primary donate-submit-btn">
            Proceed to Donate
          </button>
        </section>
      </form>
      ...
      <section className="donate-shell donate-section">
        ...
        <article className="donate-total-progress-card">
          ...
          <div className="donate-progress-track" aria-label="Total donation progress">
            <div className="donate-progress-fill donate-progress-fill-total" style={{ width: `${totalProgress}%` }} />
          </div>
        </article>
      </section>
      ...
      {paymentDraft ? (
        <div className="donate-modal-backdrop" role="presentation">
          <section className="donate-modal" role="dialog" aria-modal="true" aria-label="Simulated payment">
            ...
            <div className="donate-modal-summary">
              ...
              <p>
                ...
                {PAYMENT_METHODS.find((method) => method.id === paymentDraft.paymentMethod)?.label}
              </p>
            </div>
